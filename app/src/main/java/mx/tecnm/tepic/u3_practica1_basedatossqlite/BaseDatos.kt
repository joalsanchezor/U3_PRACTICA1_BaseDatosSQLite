...
class BaseDatos(
    ...
    override fun onCreate(p: SQLiteDatabase) {
        ...
        p.execSQL("CREATE TABLE VEHICULO( IDVEHICULO INTEGER PRIMARY KEY AUTOINCREMENT, PLACA VARCHAR(200), MARCA VARCHAR(200), MODELO VARCHAR(200), ANIO INTEGER, IDCONDUCTOR INTEGER REFERENCES CONDUCTOR(IDCONDUCTOR))")
    }
