...
class BaseDatos(
    ...
    override fun onCreate(p: SQLiteDatabase) {
        ...
        p.execSQL("CREATE TABLE VEHICULO( ID INTEGER PRIMARY KEY AUTOINCREMENT, PLACA VARCHAR(200), MARCA VARCHAR(200), MODELO VARCHAR(200), AÑO INT, IDCONDUCTOR INT, FOREIGN KEY(IDCONDUCTOR) REFERENCES CONDUCTOR(ID))")
    }
